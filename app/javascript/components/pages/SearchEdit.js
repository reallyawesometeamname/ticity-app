...
class SearchEdit extends React.Component {
  constructor(props) {
      ...
      this.state = {
          form: {
              city1: this.props.search.city1,
              city2: this.props.search.city2,
              city3: this.props.search.city3,
              housing: this.props.search.housing,
              costofliving: this.props.search.costofliving,
              startups: this.props.search.startups,
              capital: this.props.search.capital,
              travel: this.props.search.travel,
              commute: this.props.search.commute,
              business: this.props.search.business,
              safety: this.props.search.safety,
              healthcare: this.props.search.healthcare,
              education: this.props.search.education,
              environment: this.props.search.environment,
              economy: this.props.search.economy,
              taxation: this.props.search.taxation,
              internetaccess: this.props.search.internetaccess,
              leisure: this.props.search.leisure,
              tolerance: this.props.search.tolerance,
              outdoors: this.props.search.outdoors,
